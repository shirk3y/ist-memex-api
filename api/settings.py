...
API_ARTIFACT_KAFKA_HOST = os.environ.get('MEMEX_API_ARTIFACT_KAFKA_HOST')
API_ARTIFACT_KAFKA_TOPIC = os.environ.get('MEMEX_API_ARTIFACT_KAFKA_TOPIC', 'memex.api_keys')
